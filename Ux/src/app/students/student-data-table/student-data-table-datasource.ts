...
/**
 * Data source for the StudentDataTable view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class StudentDataTableDataSource extends DataSource<IStudent>{
  data: IStudent[] = [];
  ...
  private getSortedData(data: IStudent[]): IStudent[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'birthday': return compareDate(a.birthday, b.birthday, isAsc);
        default: return 0;
      }
    });
  }
